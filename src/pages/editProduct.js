...
const EditProduct = () => {
  ...
  const [formData, setFormData] = useState({
    id: route.state.a.id,
    name: route.state.a.name,
    model: route.state.a.model,
    price: route.state.a.price,
    brand: route.state.a.brand,
    color: route.state.a.color
  });



  console.log(route.state.a);
  ...
  const requisição = (a) => {
    ...
    axios.put(`https://apiproducts-rij8.onrender.com/product/${formData.id}`, postData,{
      headers: {
        Authorization: `${token}` 
      }
    })
  ...
  return (
    ...
    <div className='container_login'>
      <form onSubmit={handleSubmit} className='fomulario_login'>
        <h3 className='title'>Atualize seu Produtro</h3>
